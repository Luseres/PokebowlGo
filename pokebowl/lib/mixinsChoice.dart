...
class CustomRadioMixState extends State<CustomRadioMix> {
  ...
  void initState() {
    ...
    super.initState();
    sampleData.add(new RadioModel(false, 'Cilantro', '5'));
    sampleData.add(new RadioModel(false, 'Cucumber', '5'));
    sampleData.add(new RadioModel(false, 'Jalapeño', '5'));
    sampleData.add(new RadioModel(false, 'Onion', '5'));
  }
