...
class CustomRadioProtein extends StatefulWidget {
  @override
  createState() {
    return new CustomRadioProteinState();
  }
}

class CustomRadioProteinState extends State<CustomRadioProtein> {
  ...
  void initState() {
    ...
    super.initState();
    sampleData.add(new RadioModel(false, 'Chicken', '5'));
    sampleData.add(new RadioModel(false, 'Salmon', '5'));
    sampleData.add(new RadioModel(false, 'Tuna', '5'));
    sampleData.add(new RadioModel(false, 'Shrimp', '5'));
  }
