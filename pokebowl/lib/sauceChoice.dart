...
class CustomRadioSauce extends StatefulWidget {
  @override
  createState() {
    return new CustomRadioSauceState();
  }
}

class CustomRadioSauceState extends State<CustomRadioSauce> {
  ...
  void initState() {
    ...
    super.initState();
    sampleData.add(new RadioModel(false, 'Sesame', '5'));
    sampleData.add(new RadioModel(false, 'Sweet Chili', '5'));
    sampleData.add(new RadioModel(false, 'Spicy Mayo', '5'));
    sampleData.add(new RadioModel(false, 'Wasabi Aioli', '5'));
  }
