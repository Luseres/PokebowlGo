...
class CustomRadioToppingsState extends State<CustomRadioToppings> {
  ...
  void initState() {
    ...
    super.initState();
    sampleData.add(new RadioModel(false, 'Pineapple', '5'));
    sampleData.add(new RadioModel(false, 'Tamago', '5'));
    sampleData.add(new RadioModel(false, 'Corn', '5'));
    sampleData.add(new RadioModel(false, 'Sesame Seed', '5'));
  }
